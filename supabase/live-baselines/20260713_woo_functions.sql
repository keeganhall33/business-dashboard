-- ============================================================================
-- LIVE BASELINE SNAPSHOT: WooCommerce RPCs (Captured 2026-07-13, read-only)
-- This file records the exact production definitions for reference only.
-- Do NOT execute as a migration; functions are already live in Supabase.
-- ============================================================================

-- Owner: postgres | Schema: exec_dashboard | Function: get_woo_metrics(date,date)
-- Grants: EXECUTE to postgres, PUBLIC
...
-- Owner: postgres | Schema: public | Function: get_woo_metrics(date,date)
-- Grants: EXECUTE to service_role, authenticated, anon, postgres, PUBLIC
