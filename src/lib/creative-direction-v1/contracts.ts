...
export const CREATIVE_DIRECTION_CANDIDATE_REQUIRED_FIELDS = [
  "DIRECTION_ID",
  "MEDIUM",
  "MATERIALS",
  "SIZE_SCALE",
  "SUBJECT_OR_NON_SUBJECT",
  "COMPOSITION",
  "PALETTE_COLOR_LOGIC",
  "LIGHTING",
  "DETAIL_EDGE_TREATMENT",
  "NEGATIVE_SPACE",
  "FIGURATION_ABSTRACTION_SURREAL_HYBRID",
  "PHYSICAL_DEPTH_OR_RELIEF",
  "SERIES_STRUCTURE",
  "DISPLAY_INSTALLATION",
  "TARGET_COLLECTOR_OR_INSTITUTION",
  "CURRENT_MARKET_SIGNAL",
  "LONG_TERM_PRESTIGE_SIGNAL",
  "DIFFERENTIATION",
  "KEEGAN_BRAND_FIT",
  "LEARNING_CURVE",
  "CAPACITY_COST",
  "PRICE_CEILING_OR_ECONOMIC_NOTES",
  "RIGHTS_REFERENCE_CONSTRAINTS",
  "SHORT_PATH_VALUE",
  "COMPOUNDING_ASSET_VALUE",
