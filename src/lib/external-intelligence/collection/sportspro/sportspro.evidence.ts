...
export function buildSportsProEvidenceReference(input: {
  ...
  // Boardroom-style semantic hash inputs (link-only legal boundary):
  // canonical_url + title + published_at + excerpt.
  ...
  return {
    ...
    legal_policy_version: "sportspro.rss.link_only.v1",
