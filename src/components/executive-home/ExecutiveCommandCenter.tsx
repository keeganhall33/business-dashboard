          ...
          <Panel title="Do now" subtitle="Operational work, separated from Keegan approvals.">
            <div className="space-y-3">
              {commandCenter.do_now.map((item) => (
                <button key={item.id} type="button" onClick={() => setActiveDetailId(item.id)} className="w-full rounded-2xl border border-stone-200 bg-white p-4 text-left shadow-sm">
                  <div className="flex items-start justify-between gap-3">
