...
const PRIMARY_NAV_IDS = new Set(["EXECUTIVE_HOME", "STRATEGY", "OPPORTUNITIES_ACTIONS", "RELATIONSHIPS_CRM", "ASK_JEEVES"]);
const PRIMARY_NAV_ITEMS = NAV_ITEMS.filter((item) => PRIMARY_NAV_IDS.has(item.id));
const MORE_NAV_ITEMS = NAV_ITEMS.filter((item) => !PRIMARY_NAV_IDS.has(item.id));
