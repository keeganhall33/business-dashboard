  ...
  return (
    <div className="space-y-6">
      <header className="space-y-1">
        <h1 className="text-2xl font-semibold text-slate-950">Data status</h1>
        <p className="text-base text-slate-600">What the dashboard can trust today, and what is limiting its answers.</p>
      </header>
