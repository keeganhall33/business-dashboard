...
test("terms_review_status: restricted blocks automation (derived gate)", () => {
  // This test is about the semantics of the enum: restricted must be treated as non-approved.
  const parsed = SourceRegistrySourceSchema.parse({
    source_id: "x",
    display_name: "x",
    description: "x",
  ...
  assert.equal(parsed.terms_review_status, "restricted");
});
