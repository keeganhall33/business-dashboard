...
test("vercel cron: vercel.json defines exactly one cron for /api/scheduler/tick every 5 minutes", () => {
...
test("scheduler auth: Authorization Bearer <CRON_SECRET> is accepted (Vercel Cron)", async () => {
