...
export const ORCHESTRATION_V3 = Object.freeze({
  ...
  workers: Object.freeze({
    "local-a": Object.freeze({ stream: "CORE_INTELLIGENCE", worktree: path.join(OPENCLAW_ROOT, "worktrees", "local-a"), agentWorkspace: path.join(OPENCLAW_ROOT, "agent-workspaces-v3", "local-a") }),
